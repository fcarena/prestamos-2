...
@section ('contenido')
	...
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<center>
			<h1>Cancelar Contrato Oro y Joyas</h1></center>
	...
	<div class="panel-body panel panel-primary">
		...
		{!! Form::open(array('url'=>'cancelar/contratooro','method'=>'POST')) !!} 
		{{ Form::token() }}
	...
	<input type="hidden" name="tiendas_id" id="tiendas_id" class="form-control" value="{{ $oro->tienda}}">
