...
@section ('contenido')
	...
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<center>
			<h2 style="color:#FF8000">Renovacion del Contrato de ORO</h2></center>
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="form-group">
				...
				<div class="input-group-addon" style="font-family: Arial; font-size: 20pt;color: #00FF00 width:500px;height:85px">TOTAL A PAGAR</div>
					<input style="font-family: Arial; font-size: 60pt;color: #00FF00 width:500px;height:85px" type="text" name="total_pagado" id="total_pagado" class="form-control" value="{{ number_format(00.00, 2) }}">
					<span class="input-group-btn">
						<input type=image src="/img/portfolio/guardar.jpg" style="height:85px">
					</span>
				</div>
