	...
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="form-group">
            	...
            	<input type="text" name="interes" class="form-control" value="{{$categoria->interes}}" placeholder="18%">
            </div>
            <div class="form-group">
            	<label for="mora">mora</label>
            	<input type="text" name="mora" class="form-control" value="{{$categoria->mora}}" placeholder="25%">
            </div>
            <div class="form-group">
